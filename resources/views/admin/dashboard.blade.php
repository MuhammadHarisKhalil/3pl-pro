                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="card-text">{{ \App\Models\Contact::where('created_at', '>=', now()->subDays(7))->count() }}</h2>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="card-text">{{ \App\Models\Contact::whereDate('created_at', today())->count() }}</h2>
                        </div>
